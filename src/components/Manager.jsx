...
<ToastContainer />
  ...
  <tbody className="bg-green-100">
    ...
    return <tr key={index}>
      ...
      <div className="copy cursor-pointer size-7" onClick={()=>{copyText(item.site)}}><img style={{"width":"25px", height:"25px", "paddingTop":"3px", "paddingLeft":"3px"}} src="/icons/copy.png" alt="" /></div></div>
      </td>
      <td className="py-2 border border-white text-center">
      <div className="flex items-center justify-center">
        <span>{item.username}</span>
      <div className="copy cursor-pointer size-7" onClick={()=>{copyText(item.username)}}><img style={{"width":"25px", height:"25px", "paddingTop":"3px", "paddingLeft":"3px"}} src="/icons/copy.png" alt="" /></div></div>
      </td>
      <td className="py-2 border border-white text-center">
      <div className="flex items-center justify-center">
        <span>{item.password}</span>
      <div className="copy cursor-pointer size-7" onClick={()=>{copyText(item.password)}}><img style={{"width":"25px", height:"25px", "paddingTop":"3px", "paddingLeft":"3px"}} src="/icons/copy.png" alt="" /></div></div>
      </td>
      <td className="justify-center py-2 border border-white text-center flex">
        <span className="cursor-pointer mx-1" onClick={()=>{editPassword(item.id)}}><img style={{"width":"25px", height:"25px"}} src="/icons/edit.png" alt="" /></span>
        <span className="cursor-pointer mx-1" onClick={()=>{deletePassword(item.id)}}><img style={{"width":"25px", height:"25px"}} src="/icons/delete.png" alt="" /></span>
      </td>
    </tr>
})}
  </tbody>
